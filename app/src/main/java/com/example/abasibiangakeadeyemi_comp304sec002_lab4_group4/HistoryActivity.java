    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActnBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(HistoryActivity.this,AddEditbookActivity.class);
        ...
        booksViewModel.getAllBooks().observe(this, new Observer<List<Books>>() {
            ...
            public void onChanged(List<Books> books) {
                List<Books>history=new ArrayList<>();
                for(Books fictionBooks:books){
                    if(fictionBooks.getCategory().equals("History")){
                        history.add(fictionBooks);
                    }
                }
                adapter.setBooks(history);
            }
        });
